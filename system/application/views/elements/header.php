...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="<?php echo base_url(); ?>webroot/js/jquery.tipTip.minified.js"></script> <!-- jquery.tipTip -->
		<script type="text/javascript" src="<?php echo base_url(); ?>webroot/js/jquery-impromptu.3.1.js"></script> <!-- jquery-impromptu -->
		...
		<div id="navxbar">
					...
					<? echo form_open(base_url().'users/login/'); ?>
						<table>
							<tr>
								<td>
									Login: &nbsp;
									<?php echo form_input(array('name'=>'username','value'=>'email@','type'=>'text','class' => 'input_medium','size' => '15','onfocus'=>"this.value=&quot;&quot;","id"=>"UserUsername")).'';?><br />
								</td>
								<td>
									<?php echo form_input(array('name'=>'password','value'=>'password','type'=>'password','class' => 'input_medium','size' => '15','onfocus'=>"this.value=&quot;&quot;","id"=>"UserPassword")).'';?><br />
								</td>
								<td>
			...
			<!-- Search Box -->
				<div id="searchform" style="float: right; margin: 10px 20px 5px 0">
					<? echo form_open(base_url().'videos/search/'); ?>
