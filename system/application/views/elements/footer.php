    ...
    <div class="sidebar">
        ...
        <ul class="sidebar">
            <li style="background: #F0D000; padding: 10px 0px 5px 10px">
                <img src="<?php echo base_url(); ?>webroot/img/cakemelody.gif" width="214" height="33" border="0"
                     alt="">
            </li>
    ...
    <div id="footer">
        ...
        <div id="footerleft">
            ...
            <ul>
                ...
                <li><a href="http://net.tutsplus.com/tutorials/php/creating-a-file-hosting-site-with-codeigniter/"
