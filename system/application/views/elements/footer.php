			...
			<div id="contentright">
				...
				<?if(isset($this->arSesUsr["username"])){?>
				...
				<div class="sidebar">
					<!-- Latest Posts -->
					<ul class="sidebar">
						<li style="background: #F0D000; padding: 10px 0px 5px 10px">
							<img src="<?php echo base_url(); ?>webroot/img/cakemelody.gif" width="214" height="33" border="0" alt="">
						</li>
					...
					<ul class="sidebarcat">
						<? 
							...
							*/
							...
							?>
							<li><a href="<?php echo base_url(); ?>videos/category/<?=$categ["id"]?>" id=""><?=$categ["name"]?></a></li>
							<?
							}
						?>
					</ul>
		...
		<div id="footerbg">
			...
			<div id="footer">
				...
				<div id="footerleft">
					...
					<ul>
						<li><a href="http://www.open-blog.info/" target="_blank">Open blog</a></li>
						<li><a href="http://www.ionizecms.com/" target="_blank"> Ionize Cms  </a></li>
						<li><a href="http://classroombookings.com/" target="_blank"> Classroom Bookings App</a></li>
						<li><a href="http://www.bambooinvoice.org/" target="_blank"> Bamboo Invoice App</a></li>
						<li><a href="http://blazeeboy.github.com/Codeigniter-Egypt/" target="_blank"> Egypt CMS</a></li>
						<li><a href="http://max-3000.com/" target="_blank"> Max CMS</a></li>
						<li><a href="http://myclientbase.com/" target="_blank"> MyClientBase Invoice App</a></li>
						<li><a href="http://www.getfuelcms.com/" target="_blank"> Getfuel Cms</a></li>
						<li><a href="http://codefight.org/" target="_blank"> CodeFight Cms</a></li>
						<li><a href="http://pyrocms.com/" target="_blank"> Pyro Cms</a></li>
						<li><a href="https://github.com/68kb/" target="_blank"> 68 Knowledge Base App</a></li>
						<li><a href="http://designelemental.net/sitemanagr" target="_blank"> Sitemanager App</a></li>
						<li><a href="http://sourceforge.net/projects/forumprojesi/" target="_blank"> Forum App</a></li>
						...
						<li><a href="https://github.com/valfreixo/Social-Network-Framework" target="_blank"> Social Network Framework</a></li>
						...
						<li><a href="https://github.com/viaduk/BookSharing" target="_blank"> Book Sharing social network</a></li>
						...
						<li><a href="http://fotochest.com/" target="_blank"> Fotochest gall CMS</a></li>
						<li><a href="http://net.tutsplus.com/tutorials/php/creating-a-file-hosting-site-with-codeigniter/" target="_blank"> File Hosting App</a></li>
 					</ul>
				</div>
				<!-- / Footer Element Left -->
				...
				<div id="footermiddle">
					...
					<ul>
						<li><a href="http://codeigniter.com" target="_blank">codeigniter.com</a></li>
				...
				<div id="footerright">
					...
					<H1>Credits</H1>
					<p>
						Developed with Emil Maran  ( http://www.maran-emil.de ).<br />
