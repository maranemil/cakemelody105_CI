...
Diese Dienste werden nat&uuml;rlich <b>kostenlos</b> zur Verf&uuml;gung gestellt, du musst dich nur <? echo $html->link('registrieren','/users/register'); ?>.<br /><br />
Wenn du schon ein registrierter Benutzer bist, kannst du dich <?php echo $html->link('hier anmelden', '/users/login'); ?>.<br /><br />
