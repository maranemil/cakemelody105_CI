...
/*Array ( [0] => Array ( [id] => 139 [category_id] => 3 [bandname] => Awesome 3 [songtitle] => Don't Go [tubecode] => -4HhUSQA_7s [info] => [tags] => [recom] => 0 [date] => 2009-09-19 [hasimg] => 0 [removed] => 1 [ip1] => [ip2] => [views] => 334 [viewdate] => [user_id] => 1 ) */
	...
	<div class="videoBoxElem" style="height: 160px">
		...
		<div style="border:1px solid white; margin: 0 10px 10px 0; float: left">
			<div class="boxgrid captionfull">
				<A HREF="<?php echo base_url(); ?>videos/view/<?=$video["id"]?>/<?=$video["bandname"]?>">
