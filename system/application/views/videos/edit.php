...
$options = $languages;
echo form_dropdown('language', $options, $masterLanguage);
...
echo '</td><td>';
echo form_dropdown('DEKORGRUPPEID', $dekorgruppe, $dekor['DEKORGRUPPEID']) . '<br />';
echo '</td><td>';
echo $LBL["dekore"]["pflicht"];
echo '</td><td>';
...
echo '</td><td>';
echo form_dropdown('DEKORFARBRAUMID', $dekorfarbraum, $dekor['DEKORFARBRAUMID']) . '<br />';
echo '</td><td>';
echo $LBL["dekore"]["pflicht"];
echo '</td><td>';
...
echo '</td><td>';
echo form_dropdown('DEKORMATERIALARTID', $dekormaterial, $dekor['DEKORMATERIALARTID']) . '<br />';
echo '</td><td>';
echo $LBL["dekore"]["pflicht"];
echo '</td><td>';
...
echo '</td><td>';
echo form_dropdown('DEKORMASERUNGID', $dekormaserung, $dekor['DEKORMASERUNGID']) . '<br />';
echo '</td><td>';
echo $LBL["dekore"]["optional"];
echo '</td><td>';
echo 'Maserung/Rapport';
echo '</td><td>';
echo '.?';
echo '</td></tr>';
...
echo '</td><td>';
echo form_dropdown('FARBVERBUND', array(0 => 0, 1 => 1), $dekor['FARBVERBUND']) . '<br />';
echo '</td><td>';
echo $LBL["dekore"]["optional"];
echo '</td><td>';
echo 'Farberbund';
