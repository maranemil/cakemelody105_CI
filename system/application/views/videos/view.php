		...
		<div style="width: 630px; ">
			...
			<div id="layerFlash">
				<object width="630" height="376">
					<param name="movie" value="http://www.youtube.com/v/<?=$video[0]['tubecode']?>&hl=en"></param>
					<param name="wmode" value="transparent"></param>
					<embed src="http://www.youtube.com/v/<?=$video[0]['tubecode']?>&hl=en" type="application/x-shockwave-flash" wmode="transparent" width="630" height="376">
					</embed>
				</object>
			</div>
			<!-- layerFlash / -->
...
//alert(title);
			...
			DinVidItem ='<div id="videoBoxElemAlt" style="">';
...
function replaceContentFlash(videoID){
	...
	VidRepItem  ='<object width="630" height="376">';
	...
	VidRepItem +='<embed src="http://www.youtube.com/v/'+videoID+'&hl=en" type="application/x-shockwave-flash" wmode="transparent" width="630" height="376"></embed>';
	VidRepItem +='</object>';
