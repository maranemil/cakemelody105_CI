...
// noinspection JSUnresolvedVariable,JSUnresolvedFunction,JSUnusedLocalSymbols,JSUnusedGlobalSymbols,FallThroughInSwitchStatementJS
...
Autocompleter.Base = Class.create({
    ...
    getTokenBounds: function () {
        ...
        let tp;
        let index = 0, l = this.options.tokens.length;
        for (; index < l; ++index) {
...
Ajax.InPlaceCollectionEditor = Class.create(Ajax.InPlaceEditor, {
    ...
    buildOptionList: function () {
        ...
        const textFound = this._collection.any(function (entry) {
